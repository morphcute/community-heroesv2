    ...
    <div className="min-h-screen bg-[#111111] text-white font-sans">
      ...
      <div className="relative w-full h-[380px] bg-[#0a0a0a] overflow-hidden border-b border-white/[0.05]">
         ...
         <div className="relative z-20 container mx-auto px-6 h-full flex flex-col justify-center mt-4">
            {/* Back Button */}
            <Link href="/tournaments" className="flex items-center gap-2 text-[10px] text-gray-500 hover:text-[#FFD700] uppercase font-black mb-8 transition-colors w-fit tracking-widest bg-white/[0.02] px-3 py-1.5 rounded border border-white/[0.05]">
            ...
            <div className="flex flex-wrap items-center gap-4 md:gap-8 text-sm font-bold mb-8">
               ...
               <span className="text-[#FFD700] flex items-center gap-2 uppercase tracking-widest text-[11px] drop-shadow-[0_0_8px_rgba(255,215,0,0.3)]">
            ...
            <div className="flex items-center gap-4 relative">
               {alreadyJoined ? (
                  <div className="flex flex-col gap-2">
                     <button disabled className="px-8 py-3 bg-white/5 text-[#FFD700] border border-emerald-500/30 text-xs font-black rounded uppercase tracking-widest flex items-center justify-center gap-2 w-fit cursor-default shadow-[inset_0_0_20px_rgba(255,215,0,0.1)]">
      ...
      <div className="container mx-auto px-4 mt-8 pb-20">
         ...
         <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
            ...
            <div className="lg:col-span-2">
               <h3 className="text-xl font-black text-white mb-6 tracking-widest uppercase flex items-center gap-2">
                  <div className="w-1 h-5 bg-[#FFD700] rounded-sm" /> Details
               </h3>
               <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {/* Organizer / Hosted By */}
                  <div className="flex items-center gap-4 bg-[#0a0a0a] border border-white/[0.03] hover:border-[#FFD700]/20 transition-colors rounded-2xl p-4 group">
                     <div className="w-12 h-12 rounded-xl bg-white/[0.02] border border-white/[0.05] group-hover:border-[#FFD700]/30 group-hover:bg-[#FFD700]/5 flex items-center justify-center text-gray-400 group-hover:text-[#FFD700] transition-colors">
                  ...
                  <div className="flex items-center gap-4 bg-[#0a0a0a] border border-white/[0.03] hover:border-[#FFD700]/20 transition-colors rounded-2xl p-4 group">
                     ...
                     <div>
                        <div className="text-[9px] text-gray-500 font-black uppercase tracking-[0.2em] mb-0.5">Format</div>
                        <div className="text-sm font-bold text-gray-200 group-hover:text-white transition-colors">{tournamentData.gameMode?.replace('_', ' ') || "Solo"}</div>
                     </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 bg-[#0a0a0a] border border-white/[0.03] hover:border-[#FFD700]/20 transition-colors rounded-2xl p-4 group">
                     ...
                     <div>
                        <div className="text-[9px] text-gray-500 font-black uppercase tracking-[0.2em] mb-0.5">Platform</div>
                        <div className="text-sm font-bold text-gray-200 group-hover:text-white transition-colors">{tournamentData.platform || "Cross Platform"}</div>
                     </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 bg-[#0a0a0a] border border-white/[0.03] hover:border-[#FFD700]/20 transition-colors rounded-2xl p-4 group">
                     ...
                     <div>
                        ...
                        <div className="text-sm font-bold text-gray-200 group-hover:text-white transition-colors">{tournamentData.format?.replace('_', ' ') || "Single Elimination"}</div>
                     </div>
                  </div>
                  
                  {/* Prize Pool */}
                  <div className="flex items-center gap-4 bg-[#0a0a0a] border border-[#FFD700]/20 hover:border-[#FFD700]/40 transition-colors rounded-2xl p-4 shadow-[inset_0_0_20px_rgba(255,215,0,0.03)] group">
                     <div className="w-12 h-12 rounded-xl bg-[#FFD700]/10 border border-[#FFD700]/20 flex items-center justify-center text-[#FFD700] drop-shadow-[0_0_8px_rgba(255,215,0,0.5)]">
                        <Trophy className="w-5 h-5" />
                     </div>
                     <div>
                        <div className="text-[9px] text-[#FFD700]/70 font-black uppercase tracking-[0.2em] mb-0.5">Prize Pool</div>
                        <div className="text-[15px] font-black text-white group-hover:text-[#FFD700] transition-colors">
                           {(() => {
            ...
            <div className="space-y-8">
               <div className="bg-[#0a0a0a] border border-white/[0.03] rounded-3xl p-6 lg:p-8 relative overflow-hidden shadow-xl">
                  {/* Glowing Accent */}
                  <div className="absolute top-0 right-0 w-32 h-32 bg-[#FFD700]/10 blur-[50px] pointer-events-none -z-10" />
                  
                  <h3 className="text-xl font-black text-white mb-6 tracking-widest uppercase flex items-center gap-2">
                     <div className="w-1 h-5 bg-[#FFD700] rounded-sm" /> Timeline
                  </h3>
                  
                  {/* Active Status Box */}
                  <div className="bg-[#111111] border border-white/[0.05] rounded-2xl p-5 mb-8 flex items-start gap-4">
                     <div className="w-8 h-8 rounded-full bg-[#FFD700]/10 border border-[#FFD700]/20 flex items-center justify-center shrink-0 mt-0.5">
                        <Clock className="w-4 h-4 text-[#FFD700]" />
                     </div>
                     <div>
                        <div className="text-[13px] font-black text-[#FFD700] tracking-widest uppercase drop-shadow-[0_0_8px_rgba(255,215,0,0.3)] mb-1">
                  ...
                  <div className="space-y-0 relative pl-4 mt-4">
                     {/* Vertical Line */}
                     <div className="absolute left-[19px] top-3 bottom-0 w-[1.5px] bg-gradient-to-b from-[#FFD700]/40 via-white/5 to-transparent" />
            ...
            <section className="animate-in fade-in slide-in-from-bottom-8 duration-500 pb-20">
              ...
              <div className="mb-6">
                 ...
                 <div className="flex items-center gap-2">
                    <button className="px-5 py-2 hover:opacity-90 bg-[#FFD700] text-black text-xs font-black uppercase tracking-wider rounded-full transition-opacity shadow-[0_0_15px_-3px_rgba(255,215,0,0.4)]">
                      Knockout
                    </button>
                 </div>
              </div>
                          ...
                          <div key={m.id} className="bg-[#0f0f0f]/80 backdrop-blur-md border border-white/5 rounded-3xl overflow-hidden hover:border-white/10 transition-colors flex flex-col shadow-xl">
                             ...
                             <div className="relative flex items-center justify-between px-5 py-4 border-b border-white/5 bg-white/[0.01]">
                                <div className="flex-1 text-center">
                                   ...
                                   <div className={`text-[10px] font-black uppercase tracking-widest mt-1 ${m.status === 'COMPLETED' ? 'text-[#FFD700] drop-shadow-[0_0_8px_rgba(255,215,0,0.5)]' : m.status === 'ONGOING' ? 'text-yellow-500 drop-shadow-[0_0_8px_rgba(234,179,8,0.5)]' : 'text-gray-600'}`}>
                                      {m.status}
                                   </div>
                                </div>
                                <button className="w-8 h-8 rounded-full bg-[#FFD700] hover:bg-emerald-400 flex items-center justify-center transition-transform hover:scale-105 absolute right-5 shadow-[0_0_15px_-3px_rgba(255,215,0,0.4)]">
                             ...
                             <div className="flex items-center justify-between px-6 pb-8 pt-4">
                                ...
                                <div className="flex flex-col items-center gap-3 w-[80px]">
                                   ...
                                   <div className="text-center w-full">
                                      <div className="text-xs font-bold text-[#FFD700] truncate">{name1}</div>
                               ...
                               return (
                                 <div key={m.id} className="relative group">
                                    <div className={`rounded-xl border transition-all duration-300 shadow-lg relative z-10 ${
                                      m.status === 'ONGOING' ? 'bg-[#FFD700]/5 border-[#FFD700]/50 shadow-[0_0_15px_-3px_rgba(255,193,7,0.3)]' :
                                      m.status === 'COMPLETED' ? 'bg-[#1A1A1A] border-[#FFD700]/20 border-l-4 border-l-[#FFD700]' :
                                      'bg-[#111111] border-white/5 opacity-70'
                                       ...
                                       {userCanEditBracket && !isEditingThis && m.status !== "PENDING" && (
                                          <Link 
                                            ...
                                            className="absolute -top-3 -right-3 w-8 h-8 bg-[#111111] border-2 border-[#FFD700] rounded-full flex items-center justify-center shadow-lg text-[#FFD700] opacity-0 group-hover:opacity-100 transition-opacity hover:scale-110 hover:bg-[#1A1A1A] z-10"
                                       ...
                                       {isEditingThis ? (
                                         <form action={updateMatchScore} className="p-3 bg-[#111111] border border-[#FFD700]/50 rounded-xl space-y-3 z-20 relative shadow-2xl shadow-[#FFD700]/20">
                                           <input type="hidden" name="matchId" value={m.id} />
                                           <input type="hidden" name="tournamentId" value={tournament.id} />
                                           <div className="flex items-center justify-between gap-4">
                                              <span className="text-xs font-bold text-gray-300 w-24 truncate">{name1}</span>
                                              <input type="number" name="score1" defaultValue={m.score1} className="w-14 bg-black border border-white/20 rounded px-2 py-1 text-sm text-center text-white focus:border-[#FFD700] outline-none" />
                                           </div>
                                           <div className="flex items-center justify-between gap-4">
                                              <span className="text-xs font-bold text-gray-300 w-24 truncate">{name2}</span>
                                              <input type="number" name="score2" defaultValue={m.score2} className="w-14 bg-black border border-white/20 rounded px-2 py-1 text-sm text-center text-white focus:border-[#FFD700] outline-none" />
                                           </div>
                                           <div className="pt-2 border-t border-white/10 flex flex-col gap-2">
                                              <select name="winnerId" defaultValue={m.winnerId || ""} className="w-full bg-black border border-white/20 rounded px-2 py-1.5 text-xs text-white focus:border-[#FFD700] outline-none">
                                              ...
                                              <div className="flex gap-2">
                                                ...
                                                <button type="submit" className="flex-1 py-1.5 bg-[#FFD700] text-black font-black text-xs rounded hover:bg-[#FFD700]/90 transition-colors">Save</button>
                                              </div>
                                           </div>
                                         </form>
                                       ) : (
                                         <div className="p-4">
                                           {/* P1 Node */}
                                           <div className={`flex items-center justify-between p-2 rounded-lg mb-1 transition-colors ${isP1Winner ? 'bg-[#FFD700]/10 shadow-[inset_0_0_15px_rgba(255,193,7,0.1)] border border-[#FFD700]/30' : 'hover:bg-white/5'}`}>
                                              <div className="flex items-center gap-3 w-[70%]">
                                                 ...
                                                 <span className={`text-sm font-bold truncate ${isP1Winner ? 'text-[#FFD700]' : 'text-gray-200'}`}>{name1}</span>
                                              </div>
                                              <span className={`text-sm font-black ${isP1Winner ? 'text-[#FFD700]' : 'text-gray-500'}`}>{m.score1}</span>
                                           </div>
                                           ...
                                           {/* P2 Node */}
                                           <div className={`flex items-center justify-between p-2 rounded-lg transition-colors ${isP2Winner ? 'bg-[#FFD700]/10 shadow-[inset_0_0_15px_rgba(255,193,7,0.1)] border border-[#FFD700]/30' : 'hover:bg-white/5'}`}>
                                              <div className="flex items-center gap-3 w-[70%]">
                                                 <div className="w-6 h-6 rounded bg-zinc-800 flex items-center justify-center text-[10px] font-bold text-gray-400 overflow-hidden shrink-0 border border-white/5">
                                                    {p2?.user?.image ? <img src={p2.user.image} className="w-full h-full object-cover" /> : name2.charAt(0)}
                                                 </div>
                                                 <span className={`text-sm font-bold truncate ${isP2Winner ? 'text-[#FFD700]' : 'text-gray-200'}`}>{name2}</span>
                                              </div>
                                              <span className={`text-sm font-black ${isP2Winner ? 'text-[#FFD700]' : 'text-gray-500'}`}>{m.score2}</span>
                                           </div>
                                         </div>
                                       )}
                                    </div>
                                    ...
                                    {!isFinal && (
                                       <>
                                         <div className="absolute top-1/2 -right-8 w-8 h-[2px] bg-[#FFD700]/40 group-hover:bg-[#FFD700] transition-colors z-0" />
                                         {m.matchIndex % 2 === 0 ? (
                                           <div className="absolute top-1/2 -right-8 w-[2px] h-[calc(50%+1.5rem)] bg-[#FFD700]/40 group-hover:bg-[#FFD700] transition-colors z-0" />
                                         ) : (
                                           <div className="absolute bottom-1/2 -right-8 w-[2px] h-[calc(50%+1.5rem)] bg-[#FFD700]/40 group-hover:bg-[#FFD700] transition-colors z-0" />
                                         )}
                                       </>
                                    )}
                                 </div>
         ...
         {activeTab === "chat" && (
           <section className="rounded-2xl border border-border/50 bg-[#0a0a0a] shadow-xl border border-[#FFD700]/10 backdrop-blur-xl p-4 md:p-6 animate-in fade-in slide-in-from-bottom-8 duration-500">
             <div className="mx-auto max-w-3xl space-y-3 pb-6">
               {messages.length === 0 && (
                 <div className="text-sm text-muted-foreground">No messages yet.</div>
               )}
              {messages.map((message, index) => (
                <div key={message.id} className="flex items-start gap-3 p-4 rounded-xl bg-gradient-to-r bg-[#111111] to-transparent border border-white/5 hover:border-[#FFD700]/30 transition-all">
             ...
             <div className="rounded-2xl border border-white/10 focus-within:border-[#FFD700]/50 bg-[#111111] px-4 py-3 flex items-center gap-3">
         ...
         {activeTab === "prizes" && (() => {
            ...
            <section className="animate-in fade-in slide-in-from-bottom-8 duration-500 max-w-5xl mx-auto pb-20">
               ...
               <div className="relative flex justify-center mb-16 mt-4">
                  <div className="relative z-10 bg-[#111111] px-12 py-4 shadow-2xl skew-x-[-10deg] border border-2 border-[#FFD700]">
                  ...
                  {/* Ribbon Tails */}
                  <div className="absolute top-2 -left-6 w-16 h-12 bg-[#FFD700]/20 skew-x-[30deg] z-0" />
                  <div className="absolute top-2 -right-6 w-16 h-12 bg-[#FFD700]/20 skew-x-[-30deg] z-0" />
               </div>
               ...
               <div className="flex flex-col md:flex-row items-end justify-center gap-4 md:gap-6 mb-12 h-[350px]">
                  ...
                  <div className="w-[220px] bg-gradient-to-b from-[#C0C0C0]/90 to-[#808080]/90 rounded-2xl p-6 text-center shadow-[0_10px_40px_-10px_rgba(192,192,192,0.4)] border border-white/40 flex flex-col items-center justify-between h-[280px] hover:-translate-y-2 transition-transform">
                     ...
                     <div className="text-sm font-black text-lime-400 drop-shadow-[0_0_8px_rgba(255,215,0,0.8)] tracking-wider">{getPrizeAmount(2)}</div>
                  ...
                  <div className="w-[240px] bg-gradient-to-b from-[#FFD700]/95 to-[#B8860B]/95 rounded-2xl p-6 text-center shadow-[0_15px_50px_-10px_rgba(255,215,0,0.5)] border-2 border-yellow-200/50 flex flex-col items-center justify-between h-[320px] relative z-10 hover:-translate-y-2 transition-transform">
                     ...
                     <div className="text-base font-black text-lime-400 drop-shadow-[0_0_10px_rgba(255,215,0,0.9)] tracking-wider">{getPrizeAmount(1)}</div>
                  ...
                  <div className="w-[220px] bg-gradient-to-b from-[#CD7F32]/90 to-[#8B4513]/90 rounded-2xl p-6 text-center shadow-[0_10px_40px_-10px_rgba(205,127,50,0.4)] border border-orange-300/30 flex flex-col items-center justify-between h-[260px] hover:-translate-y-2 transition-transform">
                     ...
                     <div className="text-sm font-black text-lime-400 drop-shadow-[0_0_8px_rgba(255,215,0,0.8)] tracking-wider">{getPrizeAmount(3)}</div>
                     <div className="mt-4 flex flex-col items-center gap-2 w-full">
                        <div className="w-14 h-14 rounded-full bg-white/20 border-2 border-white/50 flex items-center justify-center font-black text-xl text-white shadow-inner">
             ...
             <div className="space-y-10">
                <div>
                   ...
                   <div className="space-y-4">
                      ...
                      <ul className="space-y-3 text-sm text-gray-300 font-medium list-disc pl-5 marker:text-[#FFD700]">
...
function TabLink({ children, active, href }: { 
  ...
  href: string; 
   ...
   return (
      <Link 
        href={href} 
        className={`py-5 text-xs tracking-widest font-black transition-all relative whitespace-nowrap uppercase ${
          active ? 'text-[#FFD700]' : 'text-gray-400 hover:text-white'
        }`}
      >
        {children}
        {active && (
          <div className="absolute bottom-0 left-0 w-full h-[2px] bg-[#FFD700] shadow-[0_0_15px_rgba(255,215,0,0.5)]" />
        )}
      </Link>
   )
}
...
function TimelineStep({ status, label, state }: { status: string; label: string; state: 'completed' | 'active' | 'pending' }) {
  const dotColor =
    state === 'completed' ? 'bg-[#FFD700] shadow-[0_0_10px_rgba(255,215,0,0.5)]' : 
...
function ParticipantCard({ participant, index }: { participant: { id: string; name: string; avatar: string; status: string; joinedAt: Date; mlbbId: string; inGameName: string }; index: number }) {
  ...
  return (
    <div className="rounded-2xl border border-white/5 overflow-hidden bg-[#1A1A1A] hover:border-[#FFD700]/50 hover:shadow-[0_0_20px_rgba(255,193,7,0.1)] transition-all shadow-lg flex flex-col group">
